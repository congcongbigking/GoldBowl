...
import com.china.goldbowl.utils.KeyBoardUtils;
import com.china.goldbowl.utils.StatusBarUtil;
import com.china.goldbowl.utils.Toast;
import com.china.goldbowl.view.LoadingDialog;
import com.china.goldbowl.view.ProgressDialog;
...
public abstract class BaseActivity<P extends BasePresenter> extends Activity implements BaseView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isImmersionBarEnabled()) {
            ...
            immersionBar.statusBarDarkFont(true);//字体设置成深色
            immersionBar.init();
        }
        this.initData();
    }
