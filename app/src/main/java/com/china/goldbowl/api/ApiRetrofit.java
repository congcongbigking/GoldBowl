...
import com.china.goldbowl.base.HttpLogger;
import com.china.goldbowl.base.mvp.BaseView;
import com.china.goldbowl.cookie.CookieManger;
import com.china.goldbowl.file.ProgressResponseBody;
import com.china.goldbowl.gson.DoubleDefaultAdapter;
import com.china.goldbowl.gson.IntegerDefaultAdapter;
import com.china.goldbowl.gson.LongDefaultAdapter;
import com.china.goldbowl.gson.StringNullAdapter;
import com.china.goldbowl.utils.L;
import com.china.goldbowl.utils.NetWorkUtils;
...
//        httpClientBuilder.addInterceptor(new HeadUrlInterceptor());
    ...
    public ApiRetrofit() {
        HttpLoggingInterceptor logInterceptor = new HttpLoggingInterceptor(new HttpLogger());//创建拦截对象，打印日志
        logInterceptor.setLevel(HttpLoggingInterceptor.Level.BODY);
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (request.method().equalsIgnoreCase("GET") || request.method().equalsIgnoreCase("HEAD")) {
                HttpUrl httpUrl = request.url().newBuilder()
                        .addQueryParameter("mobileType", "2")
                        .addQueryParameter("versionNumber", "2.0.0")
                        .addQueryParameter("channelCode", "google")
                        .addQueryParameter("appFlag", "crazyrupee")
                        .build();
                ...
                if (originalBody instanceof FormBody) {
                    ...
                    FormBody newFormBody = builder
                            .addEncoded("mobileType", "2")
                            .addEncoded("versionNumber", "2.0.0")
                            .addEncoded("channelCode", "google")
                            .addEncoded("appFlag", "crazyrupee")
                            .build();
